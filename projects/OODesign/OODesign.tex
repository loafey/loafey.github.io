...
\begin{Parallel}[v]{0.49\textwidth}{0.49\textwidth}
    \ParallelLText{
        ...
        \begin{itemize}
            \item Precondition(Förvilkor): Things that must be\\fullfil for the method to be called.
            ...
            \item Invariant: The needed requirements should\\be in a well formatted state.
        \end{itemize}
    }
    \ParallelRText{
...
\begin{Parallel}[v]{0.49\textwidth}{0.49\textwidth}
    ...
    \ParallelRText{
        ...
        Upper bound wildcard menads \fbox{? extends Type} and lower bound means \fbox{? super Type}.
